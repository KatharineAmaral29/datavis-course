// https://observablehq.com/@katharineamaral29/taxa-de-desemprego-nos-eua-em-agosto-de-2016-parte-2@95
  ...
  main.variable(observer("tooltip")).define("tooltip", ["d3"], function(d3)
{
  ...
  main.variable(observer("showTooltip")).define("showTooltip", ["d3","rateById","county_name"], function(d3,rateById,county_name){return(
function showTooltip(county_id, x, y){
    ...
    d3.select("#tooltip")
    .select("#county_name")
    .text(county_name.get(county_id));
...
d3.tsv("https://gist.githubusercontent.com/emanueles/7fbdcd8ee412e3e63904114cf9d7ee3a/raw/af4fd93db1be3f9033caff46d4a574a54bf9363f/unemployment.tsv").then(function (data) {
  ...
  main.variable(observer("county_name")).define("county_name", ["d3"], function(d3){return(
