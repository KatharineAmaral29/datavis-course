// https://observablehq.com/@katharineamaral29/d3-com-crossfilter-e-dc-js-e-leaflet@244
...
<link rel="stylesheet" href="https://unpkg.com/leaflet@1.5.1/dist/leaflet.css"integrity="sha512-xwE/Az9zrjBIphAcBb3F6JVqxf46+CDLwfLMHloNu6KEQCAWi6HcDUbeOfBIptF7tcCzusKFjFw2yuvEpDL9wQ=="crossorigin=""/>`
  ...
  main.variable(observer("buildvis")).define("buildvis", ["md","container","dc","d3","magnitudeDimension","magnitudeGroup","profundidadeDimension","profundidadeGroup","dataset","horaDimension","horaGroup","dateDimension"], function(md,container,dc,d3,magnitudeDimension,magnitudeGroup,profundidadeDimension,profundidadeGroup,dataset,horaDimension,horaGroup,dateDimension)
{
  ...
  let timeLine = dc.lineChart(view.querySelector("#time-chart"))
  let dataTable = dc.dataTable(view.querySelector("#dc-table-graph"))
  
  magnitudeBar.width(480)
        .height(150)
...
timeLine.width(960)
        .height(150)
        .x(d3.scaleTime().domain(d3.extent(dataset, function(d) { return d3.timeHour(d.dtg); })))
        .xUnits(d3.timeDays)
        .elasticY(true)
  ...
  main.variable(observer("circles")).define("circles", ["circlesLayer","dataset","L"], function(circlesLayer,dataset,L)
{
  ...
  main.variable(observer("dateDimension")).define("dateDimension", ["dataset_crossfilter"], function(dataset_crossfilter){return(
dataset_crossfilter.dimension(d => d.dtg)
)});
  main.variable(observer("magnitudeDimension")).define("magnitudeDimension", ["dataset_crossfilter"], function(dataset_crossfilter){return(
dataset_crossfilter.dimension(d => d.magnitude)
)});
  main.variable(observer("profundidadeDimension")).define("profundidadeDimension", ["dataset_crossfilter"], function(dataset_crossfilter){return(
dataset_crossfilter.dimension(d => d.profundidade)
)});
  main.variable(observer("horaDimension")).define("horaDimension", ["dataset_crossfilter","d3"], function(dataset_crossfilter,d3){return(
dataset_crossfilter.dimension(d => d3.timeHour(d.dtg))
)});
...
profundidadeDimension.group()
  ...
  main.variable(observer("horaGroup")).define("horaGroup", ["horaDimension"], function(horaDimension){return(
horaDimension.group()
)});
